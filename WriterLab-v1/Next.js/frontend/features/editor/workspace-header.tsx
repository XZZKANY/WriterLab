      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-500">
            把正文、版本、工作流诊断和运行时视图放进同一套深色工作区里，减少来回切换时的断层感。
          </p>
        </div>
        ...
        <div className="ml-auto flex overflow-hidden rounded-full border border-white/10 bg-[#202020]">
          <button
            className={`px-4 py-2 text-sm transition ${
              tab === "writing" ? "bg-zinc-100 text-black" : "text-zinc-400 hover:text-zinc-100"
            }`}
          ...
          <button
            className={`px-4 py-2 text-sm transition ${
              tab === "versions" ? "bg-zinc-100 text-black" : "text-zinc-400 hover:text-zinc-100"
            }`}
